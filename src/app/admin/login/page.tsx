...
export default function AdminLoginPage() {
  return (
    <div className="min-h-screen bg-primary dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          ...
          <form action={authenticateAdmin} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-primary hover:text-black dark:text-blue-400 dark:hover:text-blue-300">
                  Lupa password?
                </a>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">
                  Atau lanjutkan sebagai pengunjung
                </span>
              </div>
            </div>
