  ...
  return (
    <>
      <a
        ...
        className="mb-0 inline-flex h-9 w-9 items-center justify-center rounded-xs text-white duration-300  dark:bg-gray-dark dark:hover:bg-primary sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        aria-label="social-share"
        className="mb-0 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-xs text-white duration-300 dark:bg-gray-dark dark:hover:bg-primary"
      >
        <svg
          width="18"
          height="18"
